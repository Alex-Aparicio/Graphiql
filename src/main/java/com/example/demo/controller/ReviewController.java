...
@Tag(name = "Review", description = "operations on reviews")
@RestController
...
public class ReviewController {
    ...
    public List<ReviewResponse> findByPlaceId(
        ...
        return service.findByPlaceIdWithPagination(placeId, page, size);
    }
     ...
     * "Paginated list of reviews for the place")
     * 
     * @GetMapping("/place/{placeId}")
     * public List<ReviewResponse> findByPlaceId(
     * 
    ...
    @ApiResponse(responseCode = "200", description = "Paginated list of all reviews")
