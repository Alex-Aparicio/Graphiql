...
@Tag(name = "Review Images", description = "operations on reviews images")
@RestController
...
public class ReviewImageController {
    ...
    @ApiResponse(responseCode = "200", description = "List of all review images", content = {
            @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = ReviewImageResponse.class))) })
    @GetMapping
